...
class _SignupViewState extends State<SignupView> with TickerProviderStateMixin {
  ...
  void _signup() async {
    ...
    String role = "";
    if (_selectedRole == "Driver")         role = 'd';
    else if (_selectedRole == "Advertiser") role = 'a';
    else if (_selectedRole == "Agency")     role = 'g';
  ...
  void _showMessage(String message, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: isError ? Colors.red : const Color(0xff18B6A3),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (_bgController == null || _entryController == null || _pulseController == null) {
  ...
  // ── SIGNUP CARD ─────────────────────────────────────────────────────────────
  Widget _buildSignupCard(double pulseT) {
    return Container(
